...
static function img_EN(){
    ...
    for ($i=0; $i < $strLen ; $i++){
        ...
        // echo PUBLIC_PATH.'font/STCAIYUN.TTF';
        imagettftext($img,$fontSize,mt_rand(-30,30),$imgW/$strLen*$i+($imgW/$strLen/2)-($fontSize/2),mt_rand($fontSize,$imgH),$fontColor,ROOT.'public/CENTURY.TTF',$str[$i]);
    }
        // 添加噪点
